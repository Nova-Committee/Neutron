package committee.nova.neutron.server.ui.impl
...
class InventoryTrashcan(player: EntityPlayerMP) extends InventoryBasic(Utilities.L10n.getFromCurrentLang("inv.neutron.trashcan"), false, 36) {
